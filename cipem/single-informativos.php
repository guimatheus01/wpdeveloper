<?php get_header(); 
    if (have_posts()) {  while (have_posts()) {  the_post();
        $revista=get_post_meta(get_the_ID(), 'informativos_shotcode', true );
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <ul class="environment-breadcrumb">
                    ...
                    <li><a href="<?php echo home_url(); ?>/informativo">Informativos</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="environment-rich-editor environment-event-richeditor">
                                <div class="col-md-6">
                                    <?php echo(do_shortcode( $revista, true )); ?>
                                </div>
                                <div class="col-md-6">
                                    <?php the_content(); ?>
                                </div>
                                ...
                                <div class="environment-post-tags">
                                  ...
                                  <div class="environment-blog-social">
                                     <ul>
                                        ...
                                        <li><a href="whatsapp://send?text=Leia agora o informativo desse mês do CIPEM.  <?php the_permalink(); ?>" class="icon-whatsapp"></a
                                        ></li>
                                        <li><li><a href="mailto:?subject=INFORMATIVO DO CIPEM.&body=Veja agora no site do cipem, nosso Informativo <?php the_title(); ?>. Leia Agora: <?php the_permalink(); ?>" class="icon-mail"></a></li></li>
                                     </ul>
                                  </div>
                               </div>
                            </div>
                            ...
                            <div class="environment-event environment-related-event">
                                ...
                                <ul class="row">
                                    <?php
                                        $args = array( 'post_type' => 'informativos', 'orderby' => 'date',  'order' => 'desc', 'showposts' => 3);
