(function ($) {
	...
	function mapiAndo() {
		if ($('#full-width-map').length) {
			var myLatLng = new google.maps.LatLng(-15.590287, -56.086212);
			var mapOptions = {
				zoom: 15,
				center: myLatLng,
				scrollwheel: false,
			...
			var marker = new google.maps.Marker({
				...
				map: map,
				title: 'Legislendo',
				icon: '../wp-content/themes/legislendo/assets/images/marker.png'
			});
		} else {
			return false;
		}
	...
	google.maps.event.addDomListener(window, 'load', mapiAndo);
